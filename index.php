        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Sistem Informasi Karyawan PT Silence Wang</h1>
...
Copyright &copy; <script>document.write(new Date().getFullYear());</script> Stevanus Christian All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
