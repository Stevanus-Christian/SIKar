    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href=""><img src="assets/ncak.png" alt=""></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Aplikasi Absensi Karyawan PT Nauli Citra Alam Khatulistiwa</h1>
              <p>Website ini berfungsi sebagai sistem absensi karyawan PT Nauli Citra Alam Khatulistiwa.</p>
            </div>
          </div>
        </div>
      </div>
